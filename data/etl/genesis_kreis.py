...
FILENAME = CSV_PATH.name   # "bevoelkerung_kreis.csv"
SOURCE    = "genesis_kreis"
...
def main():
    ...
    try:
        ...
        write_import_log(conn, status="success", log_info=log_info, filename=FILENAME, source=SOURCE)
